...
#define STRING_CONFIG_H_AUTHOR "(Aleix Valdivieso, Anet config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Aleix NET"
 ...
 */
#define TEMP_SENSOR_0 1 // CAMBIADO
...
#define HEATER_0_MAXTEMP 285 // CAMBIADO
